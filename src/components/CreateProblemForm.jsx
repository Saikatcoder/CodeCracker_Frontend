...
const CreateProblemForm = () => {
  ...
  return (
    <div className='container mx-auto py-8 px-4 max-w-7xl shadow-lg'>
  <div className="card bg-base-100 shadow-xl bg-gradient-to-r from-stone-900 to-purple-900">
        <div className="card-body p-6 md:p-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8 pb-4 border-b">
            <h2 className="card-title text-2xl md:text-3xl flex items-center gap-3 text-orange-500">
